...
class PageTransitions extends React.PureComponent {
  ...
  /**
   * Returns the page object normalized.
   *
   * @param  {Object/int} options
   *
   * @return {Object}     Normalized page object. { page: [int], animation: [int] }
   */
  static normalization = (options) => {
    let opts = {};
  ...
  render() {
    ...
    return (
      <div className={classNames('pt-perspective', this.props.className)}
        ...
        {children.map((child, idx) => (
          ...
          && React.cloneElement(child, {
            ...
            nextPage: child.props.nextPage || this.nextPage,
