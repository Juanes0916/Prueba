            ...
            <UDCarousel className='unc-filter' steps={[
              {
                ...
                label: (
                  <div>
                    ...
                    competitivo y están obligados, a lo largo de su residencia, a crear un
                    blog en la página del centro y a publicar con regularidad comentarios,
                    ideas y vídeos sobre su trabajo. También deben presentar tres actuaciones
              ...
              },
              {
                ...
                label: (
                  <div>
                    Los públicos, por su parte, reciben instrucciones para facilitar sus opiniones
                    mediante el Proceso de Respuesta Crítica (CRP, en sus siglas en inglés),
                    desarrollado por Liz Lerman, un formato de recopilación de comentarios
                    centrado en el artista.
                  </div>
                )
              },
              {
                ...
                label: (
                  <div>
                    Al final de su período de residencia, los artistas deben ofrecer una última
                    representación pública, seguida por un debate post-evento organizado por el
                    personal de CounterPULSE. El centro envía, además, un correo de seguimiento a
                    su público, en el que se incluye un enlace a la zona de comentarios de su
                    página web, en la que se puede continuar con la conversación a través de
                    internet.
                  </div>
                )
              },
              {
                ...
                label: (
                  <div>
                    También registra de manera periódica, mediante flipcams, las reacciones del
                    público al trabajo que van realizando los artistas residentes, cargando después
                    los contenidos en su canal de YouTube.
                  </div>
                )
              }
            ]}
